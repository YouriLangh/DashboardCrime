...
function HourlyTrend({ filters }) {
    ...
    const CustomTooltip = ({ active, payload, label }) => {
        if (active && payload && payload.length) {
          return (
            <div className='custom-tooltip' style={{backgroundColor: "#f5f5f5", borderRadius: "5px", padding: "5px",fontSize: "14px",
            fontWeight: '800', 
            color: "black"}}>
            ...
            {isDataEmpty ? (
              ...
              <ResponsiveContainer  width="100%" height="100%">
                <AreaChart data={data}>
                    ...
                    />
                    <YAxis stroke='#fff'/>
                    <Tooltip cursor={{ fill: "#42424F" }} content={<CustomTooltip />} contentStyle={{
